...
These files are intended for the iPhone screenshot slot in App Store Connect. The layout uses short Japanese copy, app branding, and UI-based compositions for the core release story:
