...
Generated iPhone screenshots for the App Store product page.
...
These files are intended for the iPhone and iPad screenshot slots in App Store Connect. The layout uses short Japanese copy, app branding, and UI-based compositions for the core release story:
