...
- [ ] V01 Complete the remaining manual TalkBack traversal, physical matched dark/system-200%-font checks, API 26-28 target and Google/reference target. C65 covers only one current non-Google OEM/API 35 device and does not close Play/FCM/notification-delivery rows.
