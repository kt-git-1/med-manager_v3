...
| Physical release verification | PARTIAL | One current non-Google OEM Debug target has authenticated role, appearance, lifecycle, permission, local alarm/Doze/standby/tap/cancellation, legal-link/link-code I/O and read-only cached/cold offline recovery evidence; signed Play plus old/reference devices, destructive/mutation-interruption paths, spoken TalkBack and Firebase remain |
