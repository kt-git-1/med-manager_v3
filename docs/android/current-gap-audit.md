...
1. Complete remaining emulator-verifiable fresh iOS/Android visual pairs outside the C42–C45 UI-101/UI-102/UI-103 matrices; the C36 187-test API 26/33/35 matrix is complete at 561/561 and the expanded current API-35 suite passes 207/207 after C45.
