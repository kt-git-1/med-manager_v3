...
| Physical release verification | PARTIAL | One current non-Google OEM Debug target has authenticated role, appearance, lifecycle, permission, local alarm/Doze/standby/tap/cancellation and legal-link/link-code I/O evidence; signed Play plus old/reference devices, destructive/network paths, spoken TalkBack and Firebase remain |
