...
The latest complete command below passes 102/102 API-35 instrumentation tests, all JVM tests, Debug/Release assembly and Android Lint. The identical instrumentation suite also passes 102/102 on API 26 and API 33, for 306/306 total:
