...
The latest complete command below passes 104/104 API-35 instrumentation tests, all JVM tests, Debug/Release assembly and Android Lint. The identical instrumentation suite also passes 104/104 on API 26 and API 33, for 312/312 total:
