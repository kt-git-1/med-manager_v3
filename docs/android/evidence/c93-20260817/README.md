...
- The generated evidence JSON identified full source commit `4927f5dbc6fca94adbb3f9b648734413ed195112` and contained the exact ordered nine-gate set with `bundle-install-surface` between AAB content and Play assets. C94 subsequently extends the current set to ten with `device-split-install-surface`; C94 evidence verifies that update rather than changing this historical run.
