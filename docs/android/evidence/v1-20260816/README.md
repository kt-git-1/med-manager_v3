...
- Android branch: `android-dev`; source base before the latest evidence change: `2aea86b`.
...
- Latest artifact: configured adb-installed Debug APK, `versionCode=1`, `versionName=1.0.6`, SHA-256 `d311f2847fc608d46f19d7e73f3396d58981a14262e12ac9d4b0a821eecd279f`.
...
| DV-003 | Same | Test APK and synthetic fixtures | Complete Compose UI regression passes on physical API 35 | Latest complete run passed 273/273 in 6m57s with 0 skipped/failed | PASS | `:app:connectedDebugAndroidTest` |
| DV-004 | Local build | Source change applied | JVM, lint, both APK variants and secret-free Play preflight remain healthy | JVM 203/203; Lint passed; Debug and Release assembly passed; Release compatibility and Play assets passed; latest local unsigned Release APK SHA-256 `aba120934359870b626bc76db3d07fa24c4465a3c5f5b67ac972700952d8d2ac` | PASS | Gradle and compatibility-script reports generated locally |
...
| PN-010 | A302SH / Debug | Generated future AlarmManager plan | Pending reminders are cancelled when disabled | Turning master OFF removed active package alarms; exact wait-through-target and logout/uninstall cases were not run | NOT_RUN | Cancellation diagnostic passed; full matrix case remains |
