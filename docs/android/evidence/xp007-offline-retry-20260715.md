...
- The complete API-level instrumentation matrix is recorded in `i01-api-matrix-20260715.md`: API 26, 33 and 35 each pass 101/101 (303/303 total), alongside Debug/Release assembly and Lint.
