...
- Current action: execute the Gate I physical-device and Play Internal/Closed release runbook; C42–C45 complete the current-runtime UI-101 exceptional states plus UI-102 dose-detail and UI-103 patient-PRN matrices, while live Firebase, physical devices and release-owner signing remain external prerequisites
