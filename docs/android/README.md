...
- Current action: continue UI-202 caregiver medication-list residuals before the Gate I physical-device and Play Internal/Closed runbook; C42–C48 complete UI-101–106 and C49 closes the emulator-verifiable UI-201 exceptional/dark/adaptive matrix, while live Firebase, physical devices and release-owner signing remain external prerequisites
