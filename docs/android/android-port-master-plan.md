...
### Current checkpoint — C70 (2026-08-16)
...
- C65-C70 now cover one non-Google OEM/API 35 Debug target, including local reminder lifecycle, safe browser/link-code I/O and read-only offline recovery. V1 remains open for API 26–28 and Google/reference devices, remaining destructive/mutation-interruption paths, complete spoken TalkBack, Firebase/FCM, a release-owner signed AAB, Play Internal/Closed testing, Console declarations and the final pre-merge main rebaseline.
