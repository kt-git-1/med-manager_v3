...
final class FeatureGateTests: XCTestCase {
    ...
    func testMultiplePatientsRequiresPremium() throws {
        XCTAssertEqual(FeatureGate.multiplePatients.requiredTier, .premium)
    }

    func testExtendedHistoryRequiresPremium() throws {
        XCTAssertEqual(FeatureGate.extendedHistory.requiredTier, .premium)
    }

    func testPdfExportRequiresPremium() throws {
        XCTAssertEqual(FeatureGate.pdfExport.requiredTier, .premium)
    }

    func testEnhancedAlertsRequiresPremium() throws {
        XCTAssertEqual(FeatureGate.enhancedAlerts.requiredTier, .premium)
    }

    func testEscalationPushRequiresPro() throws {
        XCTAssertEqual(FeatureGate.escalationPush.requiredTier, .pro)
    }

    // MARK: - isUnlocked Logic

    func testPremiumGateUnlockedWhenPremium() throws {
        XCTAssertTrue(FeatureGate.isUnlocked(.multiplePatients, for: .premium))
    }

    func testPremiumGateLockedWhenFree() throws {
        XCTAssertFalse(FeatureGate.isUnlocked(.multiplePatients, for: .free))
    }

    func testPremiumGateLockedWhenUnknown() throws {
        XCTAssertFalse(FeatureGate.isUnlocked(.multiplePatients, for: .unknown))
    }

    func testEscalationPushLockedEvenWhenPremium() throws {
        XCTAssertFalse(FeatureGate.isUnlocked(.escalationPush, for: .premium))
    }

    func testEscalationPushLockedWhenFree() throws {
        XCTAssertFalse(FeatureGate.isUnlocked(.escalationPush, for: .free))
    }

    func testInitialReleaseDisablesBillingEntryPoints() throws {
