...
const featureRows = [
  {
    label: "予定",
    title: "今日飲むお薬を時間帯ごとに整理",
    body: "朝・昼・夕・寝る前の予定をひと目で確認できます。本人画面では迷わず記録できる大きな操作にしています。"
  },
  {
    label: "見守り",
    title: "家族が記録状況を確認",
  ...
  },
  {
    label: "在庫",
    title: "残量と補充タイミングを確認",
    body: "お薬の残り数を管理し、少なくなったものを見落としにくくします。通院前や薬局に行く前の確認にも使えます。"
  }
];
    ...
    <main className="page">
      <section className="hero" aria-labelledby="home-title">
        ...
        <div className="hero-copy">
          ...
          <p>
            お薬見守りは、毎日の服薬予定・服薬記録・お薬の在庫を家族で確認するためのアプリです。
      ...
      <section className="demo-section" aria-labelledby="demo-title">
        ...
        <div className="demo-layout">
          <div className="demo-copy">
            ...
            <p>
              予定の時間帯ごとにお薬をまとめ、飲めたら大きなボタンで記録します。
