...
- [ ] T001 [P] [US4] Create test fixtures, mock setup, and register upsert tests in `api/tests/integration/push-register.test.ts`
...
- [ ] T002 [P] [US4] Create unregister disable tests in `api/tests/integration/push-register.test.ts`
...
- [ ] T003 [P] [US4] Create auth and validation error tests in `api/tests/integration/push-register.test.ts`
...
- [ ] T004 [P] [US2] Create push send trigger tests in `api/tests/integration/push-send-trigger.test.ts`
...
- [ ] T005 [P] [US2] Create dedup tests preventing duplicate sends in `api/tests/integration/push-send-trigger.test.ts`
...
- [ ] T006 [P] [US4] Create fallback eventKey and linkage scoping tests in `api/tests/integration/push-send-trigger.test.ts`
...
- [ ] T007 [P] [US1] Create unit tests for CaregiverPushSettingsViewModel in `ios/MedicationApp/Tests/Push/CaregiverPushSettingsTests.swift`
...
- [ ] T008 [P] [US3] Create unit tests for push deep link routing in `ios/MedicationApp/Tests/Push/PushDeepLinkTests.swift`
...
- [ ] T009 [P] [US1] Create UI smoke test for caregiver push toggle and overlay in `ios/MedicationApp/Tests/Push/CaregiverPushUITests.swift`
...
- [ ] T010 [P] [US3] Create UI smoke test for push tap deep link to History in `ios/MedicationApp/Tests/Push/CaregiverPushUITests.swift`
...
- [ ] T011 [P] [US1] Create UI smoke test verifying patient mode has no push settings in `ios/MedicationApp/Tests/Push/CaregiverPushUITests.swift`
...
- [ ] T012 [US4] Locate existing auth middleware (`requireCaregiver`), caregiver-patient linkage query, and TAKEN trigger sites in `api/src/`
...
- [ ] T013 [US4] Add PushDevice and PushDelivery models to Prisma schema and run migration in `api/prisma/schema.prisma`
...
- [ ] T014 [P] [US4] Implement PushDevice repository in `api/src/repositories/pushDeviceRepo.ts`
...
- [ ] T015 [P] [US4] Implement PushDelivery repository in `api/src/repositories/pushDeliveryRepo.ts`
...
- [ ] T016 [P] [US4] Implement push register/unregister validator in `api/src/validators/pushRegister.ts`
...
- [ ] T017 [US4] Implement POST /api/push/register route in `api/app/api/push/register/route.ts`
...
- [ ] T018 [US4] Implement POST /api/push/unregister route in `api/app/api/push/unregister/route.ts`
...
- [ ] T019 [US4] Implement FCM HTTP v1 sender service in `api/src/services/fcmService.ts`
...
- [ ] T020 [US4] Add NotRegistered/invalid-token handling to disable PushDevice on send errors in `api/src/services/fcmService.ts`
...
- [ ] T021 [US2] Implement notifyCaregiversOfDoseTaken with dedup in `api/src/services/pushNotificationService.ts`
...
- [ ] T022 [US2] Wire push trigger into slotBulkRecordService.ts — single push per bulk in `api/src/services/slotBulkRecordService.ts`
...
- [ ] T023 [US2] Wire push trigger into doseRecordService.ts and prnDoseRecordService.ts in `api/src/services/doseRecordService.ts`, `api/src/services/prnDoseRecordService.ts`
...
- [ ] T024 [US4] Verify all backend tests pass (T001-T006) against implemented code
...
- [ ] T025 [US1] Add Firebase SDK (SPM) and configure in AppDelegate in `ios/MedicationApp/App/AppDelegate.swift`
...
- [ ] T026 [US1] Modify DeviceTokenManager for FCM tokens in `ios/MedicationApp/Services/DeviceTokenManager.swift`
...
- [ ] T027 [P] [US1] Add registerPushDevice and unregisterPushDevice to APIClient in `ios/MedicationApp/Networking/APIClient.swift`
...
- [ ] T028 [US1] Add CaregiverTab.settings and CaregiverSettingsView in `ios/MedicationApp/Features/PatientManagement/CaregiverHomeView.swift`, `ios/MedicationApp/Features/Settings/CaregiverSettingsView.swift`
...
- [ ] T029 [US1] Implement CaregiverPushSettingsViewModel in `ios/MedicationApp/Features/Settings/CaregiverPushSettingsViewModel.swift`
...
- [ ] T030 [US3] Extend NotificationDeepLinkRouter for remote push payload parsing in `ios/MedicationApp/Features/Notifications/NotificationDeepLinkRouter.swift`
...
- [ ] T031 [US3] Extend NotificationCoordinator to route remote push taps in `ios/MedicationApp/Features/Notifications/NotificationDeepLinkRouter.swift`
...
- [ ] T032 [US3] CaregiverHomeView: consume deep link target and switch to History tab in `ios/MedicationApp/Features/PatientManagement/CaregiverHomeView.swift`
...
- [ ] T033 [US3] HistoryMonthView: deep link scroll to date/slot with highlight in `ios/MedicationApp/Features/History/HistoryMonthView.swift`
...
- [ ] T034 [P] [US1] Add push-related localization strings to `ios/MedicationApp/Resources/Localizable.strings`
...
- [ ] T035 [US1] Ensure patient mode hides push settings and cannot register (defensive) in `ios/MedicationApp/Features/PatientManagement/CaregiverHomeView.swift`
...
- [ ] T036 [US1] Verify all iOS tests pass (T007-T011) against implemented code
...
- [ ] T037 [P] [US5] Verify and update quickstart.md against implementation in `specs/012-push-foundation/quickstart.md`
...
- [ ] T038 [P] [US5] Verify and update contracts/openapi.yaml against implementation in `specs/012-push-foundation/contracts/openapi.yaml`
...
- [ ] T039 [P] [US5] Verify and update data-model.md against migration in `specs/012-push-foundation/data-model.md`
...
- [ ] T040 [P] Run full test suite validation — both backend and iOS
