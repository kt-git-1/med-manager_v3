...
internal fun sessionUserMessageText(message: SessionUserMessage): String = when (message) {
    ...
    SessionUserMessage.AuthForbidden -> stringResource(R.string.session_error_auth_forbidden)
    SessionUserMessage.AuthNotFound -> stringResource(R.string.session_error_auth_not_found)
    SessionUserMessage.AuthUnavailable -> stringResource(R.string.session_error_auth_unavailable)
