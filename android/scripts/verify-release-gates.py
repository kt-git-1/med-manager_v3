    ...
    for index, gate in enumerate(gates):
        ...
        if gate_id == "RG-005":
            ...
            _require(
                ...
                "RG-005 must retain Play generated-APK read authority",
            )
            ...
            _require(
                ...
                "RG-005 must retain C110 store-ledger evidence",
            )
            _require(
            ...
            _require(
                "docs/android/evidence/c113-20260817/README.md" in sources,
            ...
            _require(
                any(
                    "generatedapks.list" in item
                    and "C114/C116" in item
                    and "App Links" in item
                    and "app-signing certificate set" in item
                    and "upload certificate" in item
                    and "C117" in item
                    for item in done_when
                ),
        ...
        if gate_id == "RG-006":
            ...
            _require("C119" in prerequisites, "RG-006 must retain the C119 installed-package receipt")
            _require(
            ...
            _require(
                "docs/android/evidence/c119-20260817/README.md" in sources,
                "RG-006 must retain C119 installed-package receipt evidence",
            )
            _require(
                any(
            ...
            _require(
                any(
                    "generatedapks.list" in item
                    and "exact version" in item
                    and "base-master" in item
                    and "app-signing certificate set" in item
                    and "C117" in item
                    for item in done_when
                ),
            ...
            _require(
                any(
                    "physical Play-installed package" in item
                    and "Google Play installer identity" in item
                    and "C118 base.apk byte match" in item
                    and "optimized split" in item
                    and "App Links" in item
                    and "C119" in item
                    for item in done_when
                ),
                "RG-006 must require the physical package receipt chained to C118",
            )
        ...
        if gate_id == "RG-009":
            ...
            _require("C110" in prerequisites, "RG-009 must retain the C110 store-ledger binding")
            _require(
            ...
            _require(
                "docs/android/evidence/c110-20260817/README.md" in sources,
                "RG-009 must retain C110 store-ledger evidence",
            )
            _require(
