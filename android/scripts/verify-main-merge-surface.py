...
EXPECTED_API_PATHS = {
    ...
    "api/scripts/prepare-android-production-database.mjs",
    "api/scripts/test-prepare-android-production-database.mjs",
    "api/scripts/test-verify-android-production-control-plane.mjs",
    "api/scripts/test-verify-android-production-release.mjs",
    "api/scripts/test-verify-android-play-policy-readiness.mjs",
    ...
    "api/scripts/verify-android-production-control-plane.mjs",
    "api/scripts/verify-android-play-policy-readiness.mjs",
    ...
    "api/src/repositories/databaseTls.ts",
    "api/src/repositories/doseRecordRepo.ts",
    "api/src/repositories/prisma.ts",
    ...
    "api/tests/unit/database-tls.test.ts",
